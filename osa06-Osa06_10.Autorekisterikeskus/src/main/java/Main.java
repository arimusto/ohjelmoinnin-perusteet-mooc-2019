...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ajoneuvorekisteri omistajat = new Ajoneuvorekisteri();
        
        omistajat.lisaa(rek1, "Arto");
        omistajat.lisaa(rek3, "Jürgen");

        System.out.println(omistajat.hae(rek1));
        
        omistajat.tulostaRekisterinumerot();
        omistajat.tulostaOmistajat();
